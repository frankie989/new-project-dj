...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "icon-eye-usage",
      viewBox: "0 0 25 19",
      url: __webpack_require__.p + "icons.svg#icon-eye",
      toString: function () {
        return this.url;
      }
    });
...
var svg4everybody = __webpack_require__(811);
var svg4everybody_default = /*#__PURE__*/__webpack_require__.n(svg4everybody);
;// CONCATENATED MODULE: ./app/js/svgUse.js
class SvgUse {
  constructor() {
    this.init();
  }
...
;// CONCATENATED MODULE: ./app/js/amount.js
const amount = (a, b) => a * b;

/* harmony default export */ const js_amount = (amount);
;// CONCATENATED MODULE: ./app/js/showLog.js
const showLog = x => console.debug(x);

/* harmony default export */ const js_showLog = (showLog);
;// CONCATENATED MODULE: ./app/app.js
// Load icons
const requireAll = r => r.keys().forEach(r);

requireAll(__webpack_require__(630));
...
window.svg4everybody = (svg4everybody_default());
document.addEventListener('DOMContentLoaded', () => {
  new SvgUse();
  js_showLog(js_amount(3, 5));
});
})();
